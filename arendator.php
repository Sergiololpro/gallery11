            ...
            <div class="arendator__top">
                ...
                <div class="arendator__right">
                    ...
                    <div class="arendator__line">
                        ...
                        <div class="arendator__room">Шоурум 12</div>
            ...
            <div class="arendator__desc">
                ...
                <div class="arendator__wp">
                    ...
                    <ul class="arendator__ul">
                        <li>Разнообразный и богатый опыт говорит нам</li>
                        <li>Что внедрение современных методик</li>
                        <li>В своём классическом представлении</li>
                        <li>Принимая во внимание показатели </li>
                    </ul>
                </div>
            </div>
        </div>
